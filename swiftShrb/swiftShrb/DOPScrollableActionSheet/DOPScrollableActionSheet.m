...
#define horizontalMargin  ([UIScreen mainScreen].bounds.size.width-240)/5.0;
...
//                [self addSubview:separator];
        ...
        [cancel setTitleColor:[UIColor colorWithRed:235.0/255.0 green:75.0/255.0 blue:75.0/255.0 alpha:1] forState:UIControlStateNormal];
